...
//all the routes built here are

//Route for a user to add resume details 
...
//Route for a user to update resume details
...
//Route to get user's resume details
...
//Route for a user to delete a resume
